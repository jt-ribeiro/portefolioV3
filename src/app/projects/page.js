...
const PROJECTS = [
  ...
  },
  {
    ...
    demo: "",
    website: "",
    tech: ["Next.js", "Prisma", "PostgreSQL", "QR Code"],
    color: "#7c3aed",
    icon: "📱",
  ...
  },
  {
    ...
    desc: "Solução web completa para clínica de prestígio. Integração de Chatbot inteligente (Ana) para triagem automática de pacientes, sistema de marcações e design focado em conversão.",
    github: "https://github.com/jt-ribeiro/websiteDentista.git",
    demo: "",
    website: "",
    tech: ["Next.js 14", "Framer Motion", "Lucide React", "Chatbot"],
    color: "#10b981",
    icon: "🦷",
  ...
  return (
    <section className={styles.projects}>
      <div className={styles.container}>
        ...
        >
          <span className={styles.pageTag}>./projects</span>
          <h1 className={styles.pageTitle}>
            O que <span className={styles.accent}>Construí</span>
          </h1>
          <p className={styles.pageSubtitle}>
            Projetos reais com impacto real — da ideia ao deploy.
          </p>
        </motion.div>
          ...
          >
            <div className={styles.cardBodyInner}>
              ...
              <div className={styles.cardLinks} onClick={(e) => e.stopPropagation()}>
                ...
                {project.website && (
                  <a href={project.website} target="_blank" rel="noreferrer" className={`${styles.linkBtn} ${styles.linkBtnPrimary}`}>
