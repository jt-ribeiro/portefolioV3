...
const contactMethods = [
  ...
  },
  {
    ...
    label: "LinkedIn",
    value: "tomas-ribeiro-dev",
    href: LINKEDIN,
    color: "#0077b5",
    desc: "Connect profissional",
  },
  {
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
...
export default function Contact() {
  ...
  const handleSubmit = (e) => {
    ...
    const subject = encodeURIComponent(`Contacto de ${formState.name}`);
      ...
      <div className={styles.container}>
        ...
        >
          ...
          <h1 className={styles.pageTitle}>
            Vamos <span className={styles.accent}>trabalhar juntos?</span>
          </h1>
          <p className={styles.pageSubtitle}>
            Seja para um projeto, uma parceria ou só uma conversa — estou disponível.
          </p>
        </motion.div>
        ...
        <div className={styles.grid}>
          ...
          >
            <h2 className={styles.sectionTitle}>Encontra-me em</h2>

            {contactMethods.map(({ icon, label, value, href, color, desc }) => (
              <a
                key={label}
                href={href}
            ...
            <AnimatePresence mode="wait">
              {!sent ? (
                <motion.form
                  ...
                  id="contact-form"
                >
                  <h2 className={styles.sectionTitle}>Envia uma mensagem</h2>
                  ...
                  <div className={styles.field}>
                    ...
                    <textarea
                      ...
                      rows={5}
                      required
                      placeholder="Conta-me o teu projeto..."
                ...
                >
                  ...
                  <h3>A caminho!</h3>
                  <p>O teu cliente de email abre com a mensagem pré-preenchida. Até breve!</p>
